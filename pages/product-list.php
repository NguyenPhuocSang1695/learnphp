        ...
        <section class="product-detail-section">
            <div class="container">
                <div class="row">
                    ...
                    // First get the product type name
                    $type_sql = "SELECT type_name FROM product_types WHERE type_id = $type_id";
                    $type_result = mysqli_query($conn, $type_sql);
                    $type_row = mysqli_fetch_assoc($type_result);

                    if ($type_row) {
                        echo '<h2 class="section-title">' . $type_row['type_name'] . '</h2>';
                    }
                                    ...
                                    <div class="product-content p-3">
                                        <div class="product-info">
                                            <h3 class="product-title">
                                                <a href="product-detail.php?id=' . $row['product_id'] . '">' . $row['name'] . '</a>
                                            </h3>
