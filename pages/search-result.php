...
<head>
    ...
    <link rel="stylesheet" href="../src/css/search-result.css">
    <!-- JS   -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    if (isset($_SESSION['search_result']) && !empty($_SESSION['search_result'])) {
                        foreach ($_SESSION['search_result'] as $product) {
                            echo '<div class="col-lg-3 col-md-4 col-6">
                                <div class="product-item">
                                    <img src="../assets/images/' . $product['image'] . '" alt="' . $product['name'] . '" class="img-fluid">
                                    <h3>' . $product['name'] . '</h3>
