...
<body>
    ...
    <main class="main-content">
        ...
        <section class="pay-section">
            ...
            <!-- Form thanh toán hiện tại của bạn giữ nguyên ở đây -->
            <form method="post" action="../php/handle-pay.php">
                ...
                // Giả sử bạn đã lấy dữ liệu từ database
                $user_info;
                ?>
                <div class="container mt-5 mb-5">
                    <div class="card shadow-lg p-4">
                        <h2 class="text-center text-success mb-4">Thanh toán đơn hàng</h2>
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong><?php echo number_format($total + 30000, 0, ',', '.') . 'đ'; ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="radio" name="info_option" id="defaultInfo" value="default" checked>
                        ...
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="radio" name="info_option" id="newInfo" value="new">
                            <label class="form-check-label" for="newInfo">
                                Nhập thông tin mới
                            </label>
                        </div>
                        ...
                        <div id="customerInfo">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control"
                                    placeholder="<?php echo $user_info['first_name'] . ' ' . $user_info['last_name']; ?>">
                            </div>

                            <div class="mb-3">
                                <label style="font-weight: bold;" class="form-label">Số điện thoại:</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="address" class="form-control"
                                    placeholder="<?php echo $user_info['address']; ?>">
                            </div>
                        </div>
