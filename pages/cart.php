...
<body>
    ...
    <main class="main-content">
        ...
        <!-- CART   -->
        <section class="cart bg-gray-100 py-8">
            <div class="container">
                <h2>Giỏ hàng của bạn</h2>
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between border-bottom pb-3 mb-3 cart-header">
                            <span class="font-weight-semibold">Sản phẩm</span>
                            <span class="font-weight-semibold">Số lượng</span>
                            <span class="font-weight-semibold">Giá</span>
                            <span class="font-weight-semibold">Xóa</span>
                        </div>
